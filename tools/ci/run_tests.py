    ...
    return [
        TestCommand(
            ...
            [
                ...
                "tests/tools/performance/test_validate_kernel_gate.py",
        ...
        TestCommand(
            "production-room-modules",
            godot_base + ["--script", "res://tests/production/test_room_modules.gd"],
        ),
        TestCommand(
        ...
        TestCommand(
            ...
            godot_base + ["--script", "res://tests/production/test_progression.gd"],
        ),
        TestCommand(
            "production-crafting",
            godot_base + ["--script", "res://tests/production/test_crafting.gd"],
        ),
        TestCommand(
            "production-inventory",
            godot_base + ["--script", "res://tests/production/test_inventory.gd"],
        ),
        TestCommand(
            "production-loot",
            godot_base + ["--script", "res://tests/production/test_loot.gd"],
        ),
        TestCommand(
            "production-equipment",
            godot_base + ["--script", "res://tests/production/test_equipment.gd"],
        ),
        TestCommand(
        ...
        TestCommand(
            ...
            godot_base
            + ["--script", "res://tests/production/test_player_movement.gd"],
        ),
        TestCommand(
            "production-cast-runtime",
            godot_base
        ...
        TestCommand(
            ...
            godot_base
            + ["--script", "res://tests/production/test_status_runtime.gd"],
        ),
        TestCommand(
            "production-enemy-runtime",
            godot_base
            + ["--script", "res://tests/production/test_enemy_runtime.gd"],
        ),
        TestCommand(
        ...
        TestCommand(
            ...
            [
                sys.executable,
                "-m",
                "tools.performance.validate_kernel_gate",
